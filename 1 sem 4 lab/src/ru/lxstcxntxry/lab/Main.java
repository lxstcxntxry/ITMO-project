...
public class Main
{
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            envelope.printItem();
            envelope.printDescription();
            neznayka.manipulate(envelope, new AliveEntityAction("поднял"));

            AliveEntity kozel = new KozelAliveEntity("Козёл");
            kozel.appear();

            Place shop = new ShopPlace("Магазин");
            shop.definePlace();

            DoorItem item = new DoorItem(
                    "Дверь с вывеской",
                    new UnknownPlace("Дверь"),
            ...
            AliveEntity police = new PoliceAliveEntity("Полицейский");
            police.appear();
            ...
            AliveEntity stealer = new StealerAliveEntity("Грабитель");
            stealer.appear();
            ...
            AliveEntity trader = new TraderAliveEntity("Продавец");
            trader.appear();
